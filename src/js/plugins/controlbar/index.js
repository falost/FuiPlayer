...
const hoverColorStyle = `
  ...
  chimee-playbackrate-list:hover .chimee-playbackrate-list-arrow svg *,
  chimee-clarity:hover .chimee-clarity-list-arrow svg *{
    fill: hoverColor;
    stroke: hoverColor;
  }
  ...
  chimee-playbackrate:hover,

  chimee-clarity-list li:hover,
  chimee-clarity:hover,
...
const chimeeControl = {
  ...
  events: {
    ...
    // 进度条延迟处理，正在生成中
      let that = this
      setTimeout(() => {
        that.children.progressBar && that.children.progressBar.progress();
      }, 500);
    },
    volumechange () {
